...
THREE.ColladaExporter = function (options) {
  options = options || {};
  ...
  parse: function ( object, onDone, options = {} ) {
    ...
    function processGeometry( g ) {
      ...
      if ( meshid == null ) {
        ...
        var groups = GeometryUtil.getMaterialGroups(processGeom);
    ...
    function processObject( o ) {
      ...
      if ( o instanceof THREE.Mesh && o.geometry != null ) {
        ...
        var ogroups = GeometryUtil.getMaterialGroups(o.geometry);
        var nmats = (ogroups != null && ogroups.length !== 0) ? ogroups.length : 1;
        matids = new Array( nmats )
          .fill()
    ...
    outputFile(this.__fs, res, onDone);
...
module.exports = THREE.ColladaExporter;