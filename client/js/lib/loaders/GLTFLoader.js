...
( function () {
	...
	class GLTFLoader extends BaseLoader {
		...
		load( url, onLoad, onProgress, onError ) {
			...
			const loader = scope.getFileLoader({ responseType: 'arraybuffer', path: this.path });
		...
		loadImageSource( sourceIndex, loader ) {
				...
				if (isNodejs) {
					...
					sourceURI = parser.getDependency( 'bufferView', sourceDef.bufferView )
						...
						.then( function ( bufferView ) {
							sourceURI = { type: 'bufferView', key: 'bufferView' + '-' + sourceDef.bufferView, buffer: bufferView, mimeType: sourceDef.mimeType };
							return sourceURI;
			...
			const promise = Promise.resolve( sourceURI ).then( function ( sourceURI ) {
				...
				return new Promise( function ( resolve, reject ) {
					...
					// AXC: resolve URI to load
					const loadURI = (typeof sourceURI === 'string')? THREE.LoaderUtils.resolveURL( sourceURI, options.path ) : sourceURI;
					loader.load( loadURI, onLoad, undefined, reject );
