...
THREE.OBJLoader = function ( manager ) {
	...
	this.regexp = {
		...
		vertex_color_pattern     : /^v( +[\d|\.|\+|\-|e]+)( +[\d|\.|\+|\-|e]+)( +[\d|\.|\+|\-|e]+)( +[\d|\.|\+|\-|e]+)( +[\d|\.|\+|\-|e]+)( +[\d|\.|\+|\-|e]+)/,
		// v float float float
	...
	parse: function ( text ) {
		...
		for ( var i = 0, l = lines.length; i < l; i ++ ) {
			...
			if ( lineFirstChar === 'v' ) {
				...
				if ( lineSecondChar === ' ' && ( result = this.regexp.vertex_color_pattern.exec( line ) ) !== null ) {
					state.vertices.push(
						parseFloat(result[1]),
						parseFloat(result[2]),
						parseFloat(result[3])
				...
				} else if ( lineSecondChar === ' ' && ( result = this.regexp.vertex_pattern.exec( line ) ) !== null ) {
