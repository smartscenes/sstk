...
ScanModelAligner.prototype.init = function () {
  ...
  this.viewer.editControls.dragdrop.placementMode = Constants.EditStrategy.MovementMode.MOVE_ON_PICKING_PLANE;  // allow putting objects anywhere
...
ScanModelAligner.prototype.registerEvents = function () {
  ...
  this.viewer.renderer.domElement.addEventListener('pointerdown', function (event) {
  ...
  this.viewer.renderer.domElement.addEventListener('pointerup', function (event) {
