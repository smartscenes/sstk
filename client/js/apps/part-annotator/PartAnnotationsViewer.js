function PartAnnotationsViewer(params) {
...
PartAnnotationsViewer.prototype.init = function(params) {
  this.createCommon();
  if (params.groupBy) {
...
PartAnnotationsViewer.prototype.createCommon = function() {
...
PartAnnotationsViewer.prototype.createGroupedAnnotationsTable = function (params) {
  var scope = this;
  var resultTableSelector = params.resultTableSelector || this.resultTableSelector;
  var loadingMessageSelector = params.loadingMessageSelector || this.loadingMessageSelector;
  var annotations = params.annotations || [];
