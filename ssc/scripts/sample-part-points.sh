...
parallel --colsep=',' -j $n --eta "node --max-old-space-size=4000 $MY_PATH/../sample-part-points.js --output_dir $output_dir/meshes --input {1} $opts >& $output_dir/logs/{1}.sample.log" :::: $csv
