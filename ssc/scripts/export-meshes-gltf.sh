...
opts="--input_type ${input_type} --input_format ${input_format} --output_format ${output_format} --assetType model --embed_images --export_textures none --require_faces --use_search_controller --include_group"
