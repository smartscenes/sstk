...
function exportArticulationsWithId(source, modelId, output_filename) {
    const annotation_filename = `${STK.Constants.baseUrl}/articulation-annotations/load-annotations?modelId=${modelId}`;
    const precomputed_filename = `${STK.Constants.baseUrl}/articulations/${source}/precomputed/${modelId}.artpre.json`;
...
if (cmd.parts_filename != null && cmd.annotation_filename != null) {
